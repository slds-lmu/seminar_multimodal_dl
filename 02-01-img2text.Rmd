...
(numbers like 1 or 2.1 are just outline or keypoint for subparagraph)
1.large datasetscomputer vision research, .How does these Datasets come from : MC COCO, ImageNet (key point is COCO others ImageNet little, references not finished )
<br>
...
knitr::include_graphics("/Users/luyangchu/Downloads/seminar sose2022/multimoddl/seminar_multimodal_dl/figures/02-chapter2/2.1 annotation pipeline.png")
```
<br>
1. category labeling: determine object categories in each images on the user interface of , using hierarchical approach, dividing 91 catefories in to 11 super-categories(20k worker hours expensive)
2. label all instance of the object categories in images 10k hours
3. segmenting each object instances 
in detail  segment an object instance specified by a worker in the previous stage
...
<br>
```{r, fig.align = 'center', out.width = '100%',echo=FALSE, fig.cap="Left, [@mccoco]" }
knitr::include_graphics("/Users/luyangchu/Downloads/seminar sose2022/multimoddl/seminar_multimodal_dl/figures/02-chapter2/2.1 coco cmparison.png")
```
<br>
...
<br>
```{r, fig.align = 'center', out.width = '100%',echo=FALSE, fig.cap="Left, [@mccoco]" }
knitr::include_graphics("/Users/luyangchu/Downloads/seminar sose2022/multimoddl/seminar_multimodal_dl/figures/02-chapter2/2.1 m2.png")
```
<br>
...
<br>
```{r, fig.align = 'center', out.width = '100%',echo=FALSE, fig.cap="Left, [@mccoco]" }
knitr::include_graphics("/Users/luyangchu/Downloads/seminar sose2022/multimoddl/seminar_multimodal_dl/figures/02-chapter2/2.1 m2 example.png")
```
