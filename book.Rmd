...
* **STEP 1**:  By fixing  $\varphi = 1$ and, assuming twice more resources available, a small grid search of $\alpha, \beta, \gamma $ based Eq. (6) showed that the best values for EfficientNet-B0 are $\alpha = 1.2, \beta = 1.1, \gamma=1.15$, under constraint of $\alpha·\beta^2·\gamma^2 ≈2$.
...
(ref:crossref1) Type of images [@mccoco].

```{r imagetype, fig.align = 'center', out.width = '100%',echo=FALSE, fig.cap="(ref:crossref1)" }
...
(ref:crossref2) Annotation pipeline for COCO [@mccoco].

```{r cocoannotation, fig.align = 'center', out.width = '100%',echo=FALSE, fig.cap="(ref:crossref2)" }
...
(ref:crossref3) Comparison COCO with other PASCAL VOC, SUN and ImageNet [@mccoco].

```{r cococomparison, fig.align = 'center', out.width = '100%',echo=FALSE, fig.cap="(ref:crossref3)" }
...
(ref:crossref4) $M^2$ Transformer [@cornia2020m2].

```{r m2arc1, fig.align = 'center', out.width = '100%',echo=FALSE, fig.cap="(ref:crossref4)" }
...
(ref:crossref5) $M^2$ Transformer Architecture [@cornia2020m2].
```{r m2arc2, fig.align = 'center', out.width = '100%',echo=FALSE, fig.cap="(ref:crossref5)" }
...
(ref:crossref6) Comparison with Transformer-based alternatives [@cornia2020m2]

```{r compare1, fig.align = 'center', out.width = '100%',echo=FALSE, fig.cap="(ref:crossref6)" }
...
(ref:crossref7) Comparison with the state of the art on the “Karpathy” test split, in single-model setting [@cornia2020m2]

```{r compare2, fig.align = 'center', out.width = '100%',echo=FALSE, fig.cap="(ref:crossref7)" }
...
(ref:crossref8) "Examples of captions generated by M^2$ Transformer and the original Transformer model, as well as the corresponding ground-truths [@cornia2020m2]

```{r example2, fig.align = 'center', out.width = '100%',echo=FALSE, fig.cap="(ref:crossref8)" }
...
## Text-to-image {#c02-02-text2image
...
```{r vanillagansamples, fig.align = 'center', out.width = '80%',echo=FALSE, fig.cap="Samples from generators trained on different datasets: a) MNIST b) TFD, c) CIFAR-10 (MLP used for G and D) d) CIFAR-10 (CNN used). Highlighted columns show the nearest real example of the neighbouring sample. Figure from @GAN2014.", }
...
```{r dalleexamples, fig.align = 'center', out.width = '100%',echo=FALSE, fig.cap="Comparison of the results from Dall-E vs prior works on MS-COCO. Dall-E's outputs are chosen as the best out of 512 images, ranked by a contrastive model. Figure from @DALLE1.", }
...
```{r uncliptable, fig.align = 'center', out.width = '80%',echo=FALSE, fig.cap="Comparison of FID on MS-COCO. The best results for unCLIP were reported with the guidance scale of 1.25. Figure from @DALLE2.", }
...
## Text + Image {#c02-05-text-plus-img}
...
```{r vltasks,echo=FALSE, out.width="70%", fig.align="center", fig.cap="Uppal et al. (2022): VisLang Paper Trends (previous 2 years)"}
...
```{r data2vecoverview,echo=FALSE, out.width="100%", fig.align="center", fig.cap="Baevski et al. (2022): Data2vec Architecture - a teacher model creates contextualized latent targets on the basis of its top K layers (blue) as prediction task to train the student model"}
...
```{r visiontransformer,echo=FALSE, out.width="100%", fig.align="center", fig.cap="Dosovitskiy et al. (2021)"}
...
```{r data2vecresults1,echo=FALSE, out.width="50%", fig.align="center", fig.cap="Baevski et al. (2022): data2vec performance (vision)"}
...
```{r data2vecresults2,echo=FALSE, out.width="100%", fig.align="center", fig.cap="Baevski et al. (2022): data2vec results (language)"}
...
```{r vilbertarc,echo=FALSE, out.width="100%", fig.align="center", fig.cap="Lu et al. (2019): VilBert's Dual Stream Architecture: dashed transformer modules can be repeated, co-attention modules allow sparse interaction between modalities."}
...
```{r vilbertattention,echo=FALSE, out.width="100%", fig.align="center", fig.cap="Lu et al. (2019): Cross-Attention in VilBert"}
...
```{r vilbertmaps,echo=FALSE, out.width="100%", fig.align="center", fig.cap="Sikarwar et al. (2022): (Left to Right) Picture, Human Attention, 36 Regions, 72 Regions, 108 Regions. Similarity between human and model attention is measured using rank correlation."}
...
```{r vilbertresults,echo=FALSE, out.width="100%", fig.align="center", fig.cap="Lu et al. (2019): VilBert Performance"}
...
```{r flamingoexamples,echo=FALSE, out.width="100%", fig.align="center", fig.cap="Alayrac et al. (2022): Flamingo Prompt-Output-Examples"}
...
```{r flamingoarc,echo=FALSE, out.width="100%", fig.align="center", fig.cap="Alayrac et al. (2022): Flamingo Model Structure"}
...
```{r perceiver,echo=FALSE, out.width="50%", fig.align="center", fig.cap="Alayrac et al. (2022): Flamingo Perceiver-Resampler"}
...
```{r flamingoattention,echo=FALSE, out.width="100%", fig.align="center", fig.cap="Alayrac et al. (2022): Flamingo Gated Cross-Attention"}
...
```{r flamingodatasets,echo=FALSE, out.width="100%", fig.align="center", fig.cap="Alayrac et al. (2022): Flamingo Datasets (Table2, p.19)"}
...
```{r flamingoresult,echo=FALSE, out.width="100%", fig.align="center", fig.cap="Alayrac et al. (2022): Flamingo Results without Fine-Tuning"}
...
```{r flamingfinetune,echo=FALSE, out.width="100%", fig.align="center", fig.cap="Alayrac et al. (2022): Flamingo Results with Fine-Tuning"}
...
```{r struc-vs-unstrc, echo=FALSE, out.width="100%", fig.align="center", fig.cap="Structured vs. Unstructured Data"}
knitr::include_graphics("figures/03-02-struc+unstruc-data/Struct_vs_Unstruct_Data.png")
```
