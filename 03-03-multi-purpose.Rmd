...
#### Evolutionary Algorithms {#c03-03-EA}
...
and a [mixture-of-expert](#c03-03-MoE) layer. The I/O mixer and the decoder combine their dual input using cross-attention. A positional encoding conceptually similar to the one in transformers [@vaswani2017attention]
...
An initial model is evolved by using an [evoluationary algorithm](#c03-03-EA) to fit specific tasks, while keeping the previously learned knowledge.
