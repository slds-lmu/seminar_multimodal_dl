...
#### Multi-Task Learning
\# TODO Introduce MTL
To introduce the concept of multi-purpose models, a short introduction to multi-task-learning is necessary. Multi-modal learning,
that we alread introduced, aims at improving abstract representations by unlocking more senses to perceive the world. Mulit-task learning [Caruana todo],
also aims to improve models by training on multiple tasks. It is assumed that adding more tasks, increases the generalization capability of the model.
The transferable knowledge of a task is used in different settings. For example a model can be trained on predicting different ....
CV (more obvious tasks) -> go down to NLP and the models capability in nlp
For a more in-depth overview of mulit-task learning, we rever to @Crawshaw2020.
- catastrophic Forgetting

#### Mixture-of-Experts
\# TODO Add general idea of moe
