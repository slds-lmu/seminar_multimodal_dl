...
```{r fig:onehot, echo=FALSE, out.width="70%", fig.cap="(ref:onehot)", fig.align="center"}
...
```{r fig:embedPilehvarP11, echo=FALSE, out.width="70%", fig.cap="(ref:embedPilehvarP11)", fig.align="center"}
...
```{r fig:embedVectors, echo=FALSE, out.width="100%", fig.cap="(ref:embedVectors)", fig.align="center"}
...
```{r fig:embedTransl, echo=FALSE, out.width="90%", fig.cap="(ref:embedTransl)", fig.align="center"}
...
```{r fig:embedArch, echo=FALSE, out.width="85%", fig.cap="(ref:embedArch)", fig.align="center"}
knitr::include_graphics("./figures/01-01-nlp/embed_arch_mikolov_p5.png")
```
(ref:embedArch) CBOW and Skip-gram architecture (Source: @mikolov2013efficient).
...
```{r fig:arch1Encdec, echo=FALSE, out.width="85%", fig.cap="(ref:arch1Encdec)", fig.align="center"}
...
```{r fig:encdecArchCho, echo=FALSE, out.width="56%", fig.cap="(ref:encdecArchCho)", fig.align="center"}
...
```{r fig:encdecArch2, echo=FALSE, out.width="70%", fig.cap="(ref:encdecArch2)", fig.align="center"}
...
```{r fig:attentionExStanford, echo=FALSE, out.width="90%", fig.cap="(ref:attentionExStanford)", fig.align="center"}
...
```{r fig:attentionfocus, echo=FALSE, out.width="50%", fig.cap="(ref:attentionfocus)", fig.align="center"}
...
```{r fig:tfrnnlimstanford, echo=FALSE, out.width="70%", fig.cap="(ref:tfrnnlimstanford)", fig.align="center"}
...
```{r fig:tfrnnlim2stanford, echo=FALSE, out.width="70%", fig.cap="(ref:tfrnnlim2stanford)", fig.align="center"}
...
```{r fig:tfselfa, echo=FALSE, out.width="70%", fig.cap="(ref:tfselfa)", fig.align="center"}
...
```{r fig:tfhashtable, echo=FALSE, out.width="70%", fig.cap="(ref:tfhashtable)", fig.align="center"}
knitr::include_graphics("./figures/01-01-nlp/transformer_hash-table_stanford.png")
```
(ref:tfhashtable) Comparison of classic attention mechanism with self-attention with
...
```{r fig:tfsdpa, echo=FALSE, out.width="18%", fig.cap="(ref:tfsdpa)", fig.align="center"}
knitr::include_graphics("./figures/01-01-nlp/transformers_scaled-dot-attention2_vaswani.png")
```
(ref:tfsdpa) Scaled dot-product attention (Source: @vaswani2017attention).
...
```{r fig:tfmha, echo=FALSE, out.width="34%", fig.cap="(ref:tfmha)", fig.align="center"}
knitr::include_graphics("./figures/01-01-nlp/transformers_multi-head-attention2_vaswani.png")
```
(ref:tfmha) Multi-head attention (Source: @vaswani2017attention).
...
```{r fig:tfarch, echo=FALSE, out.width="55%", fig.cap="(ref:tfarch)", fig.align="center"}
knitr::include_graphics("./figures/01-01-nlp/transformer_arch_vaswani.png")
```
(ref:tfarch) Transformer architecture (Source: @vaswani2017attention).
...
```{r fig:tfpretrain, echo=FALSE, out.width="80%", fig.cap="(ref:tfpretrain)", fig.align="center"}
...
```{r fig:tfpretrain2, echo=FALSE, out.width="80%", fig.cap="(ref:tfpretrain2)", fig.align="center"}
...
```{r fig:gpt3scaling, echo=FALSE, out.width="70%", fig.cap="(ref:gpt3scaling)", fig.align="center"}
...
```{r fig:ctattentionheads, echo=FALSE, out.width="90%", fig.cap="(ref:ctattentionheads)", fig.align="center"}
...
```{r fig:gpt3fewshotlearning, echo=FALSE, out.width="50%", fig.cap="(ref:gpt3fewshotlearning)", fig.align="center"}
