...
[@Pilehvar2021].](embed_pilehvar_p11.png){#fig:my_label width="70%"}
...
[@Manning2022].](attention_ex_stanford.png){#fig:my_label width="90%"}
...
[@Vaswani2017]](transformers_multi-head-attention2_vaswani.png){#fig:my_label
width="34%"}
...
![Comparison of number of paramters between Transformer-architectures.
