...
```
(ref:embed_arch) CBOW and Skip-gram architecture (Source: @Mikolov2013).

<!--
![CBOW and Skip-gram architecture. Source:
[@Mikolov2013].](embed_arch_mikolov_p5.png){#fig:embed_arch width="85%"}
-->
...
Folding and ML for Systems (see [@Dosovitskiy2020], [@Jumper2021],
...
```
(ref:tf_sdpa) Scaled dot-product attention (Source: @Vaswani2017).

<!--
![Scaled dot-product attention. Source:
[@Vaswani2017].](transformers_scaled-dot-attention2_vaswani.png){#fig:tf_sdpa
width="18%"}
-->
...
```
(ref:tf_mha) Multi-head attention (Source: @Vaswani2017).

<!--
![Multi-head attention. Source:
[@Vaswani2017]](transformers_multi-head-attention2_vaswani.png){#fig:tf_mha
width="34%"}
-->
...
```
(ref:tf_arch) Transformer architecture (Source: @Vaswani2017).

<!--
![Transformer architecture. Source:
[@Vaswani2017].](transformer_arch_vaswani.png){#fig:tf_arch width="55%"}
-->
...
```
(ref:gpt3_few-shot-learning) Few-shot learning (Source: @Brown2020).

<!--
![Few-shot learning. Source:
[@Brown2020]](gpt3_few-shot-learning.png){#fig:gpt3_few-shot-learning
width="50%"}
-->
