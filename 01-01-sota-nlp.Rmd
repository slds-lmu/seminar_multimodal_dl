...
[1](#fig:one-hot){reference-type="ref" reference="fig:one-hot"}), there
are ten simple words and the dark squares indicate the only index with a
non-zero value.

```{r fig:one-hot, echo=FALSE, out.width="70%", fig.cap="(ref:one-hot)", fig.align="center"}
knitr::include_graphics("./figures/01-01-nlp/onehot_pilehvar_p10.png")
```
(ref:one-hot) Ten one-hot encoded words (Source: @Pilehvar2021).

<!--
![Ten one-hot encoded words. Source:
[@Pilehvar2021].](onehot_pilehvar_p10.png){#fig:one-hot width="70%"}
-->
...
[@mikolov2013efficient] called dimensions between 50-100 modest for more than a
...
```{r fig:embed_pilehvar_p11, echo=FALSE, out.width="70%", fig.cap="(ref:embed_pilehvar_p11)", fig.align="center"}
knitr::include_graphics("./figures/01-01-nlp/embed_pilehvar_p11.png")
```
(ref:embed_pilehvar_p11) Three-dimensional word embeddings (Source: @Pilehvar2021).

<!--
![Three-dimensional word embeddings. Source:
[@Pilehvar2021].](embed_pilehvar_p11.png){#fig:embed_pilehvar_p11 width="70%"}
-->
...
Country-Capital example (see [@mikolov2013efficient]).

```{r fig:embed_vectors, echo=FALSE, out.width="100%", fig.cap="(ref:embed_vectors)", fig.align="center"}
knitr::include_graphics("./figures/01-01-nlp/embed_vectors_google.png")
```
(ref:embed_vectors) Three types of similarities as word embeddings (Source: @Google2022).

<!--
![Three types of similarities as word embeddings. Source:
[@Google2022].](embed_vectors_google.png){#fig:embed_vectors 
width="100%"}
-->
...
```{r fig:embed_transl, echo=FALSE, out.width="90%", fig.cap="(ref:embed_transl)", fig.align="center"}
knitr::include_graphics("./figures/01-01-nlp/embed_transl_mikolova_p2.png")
```
(ref:embed_transl) Representations of numbers in English and Spanish (Source: @Mikolov2013a).

<!--
![Representations of numbers in English and Spanish. Source:
[@Mikolov2013a].](embed_transl_mikolova_p2.png){#fig:embed_transl
width="90%"}
-->
...
word2vec. It was proposed by [@mikolov2013efficient] and is not a singular
...
[@mikolov2013efficient], [@Mikolov2013a], [@Mikolov2013b]) that are stemming
...
```{r fig:embed_arch, echo=FALSE, out.width="85%", fig.cap="(ref:embed_arch)", fig.align="center"}
knitr::include_graphics("./figures/01-01-nlp/embed_arch_mikolov_p5.png")
```
(ref:embed_arch) CBOW and Skip-gram architecture (Source: @mikolov2013efficient).

<!--
![CBOW and Skip-gram architecture. Source:
[@mikolov2013efficient].](embed_arch_mikolov_p5.png){#fig:embed_arch width="85%"}
-->
...
```{r fig:arch1_encdec, echo=FALSE, out.width="85%", fig.cap="(ref:arch1_encdec)", fig.align="center"}
knitr::include_graphics("./figures/01-01-nlp/encdec_arch1_deepl.png")
```
(ref:arch1_encdec) Translation through simplified seq2seq model (Source: @Manning2022).

<!--
![Translation through simplified seq2seq model. Source:
[@Manning2022].](encdec_arch1_deepl.png){#fig:arch1_encdec width="85%"}
-->
...
```{r fig:encdec_arch_Cho, echo=FALSE, out.width="56%", fig.cap="(ref:encdec_arch_Cho)", fig.align="center"}
knitr::include_graphics("./figures/01-01-nlp/encdec_arch_Cho.png")
```
(ref:encdec_arch_Cho) Encoder-decoder architecture (Source: @Cho2014).

<!--
![Encoder-decoder architecture. Source:
[@Cho2014]](encdec_arch_Cho.png){#fig:encdec_arch_Cho width="56%"}
-->
...
```{r fig:encdec_arch2, echo=FALSE, out.width="70%", fig.cap="(ref:encdec_arch2)", fig.align="center"}
knitr::include_graphics("./figures/01-01-nlp/encdec_arch2_deepl.png")
```
(ref:encdec_arch2) Translation through seq2seq model (Source: @Manning2022).

<!--
![Translation through seq2seq model. Source:
[@Manning2022]](encdec_arch2_deepl.png){#fig:encdec_arch2 width="70%"}
-->
...
```{r fig:attention_ex_stanford, echo=FALSE, out.width="90%", fig.cap="(ref:attention_ex_stanford)", fig.align="center"}
knitr::include_graphics("./figures/01-01-nlp/attention_ex_stanford.png")
```
(ref:attention_ex_stanford) Translation process with attention mechanism (Source: @Manning2022).

<!--
![Translation process with attention mechanism. Source:
[@Manning2022].](attention_ex_stanford.png){#fig:attention_ex_stanford width="90%"}
-->
...
```{r fig:attention_focus, echo=FALSE, out.width="50%", fig.cap="(ref:attention_focus)", fig.align="center"}
knitr::include_graphics("./figures/01-01-nlp/attention_focus_bahdanau.png")
```
(ref:attention_focus) Attention alignments (Source: @Bahdanau2014).

<!--
![Attention alignments. Source:
[@Bahdanau2014].](attention_focus_bahdanau.png){#fig:attention_focus
width="50%"}
-->
...
```{r fig:tf_rnnlim_stanford, echo=FALSE, out.width="70%", fig.cap="(ref:tf_rnnlim_stanford)", fig.align="center"}
knitr::include_graphics("./figures/01-01-nlp/transformer_rnnlim_stanford.png")
```
(ref:tf_rnnlim_stanford) Sequential processing of recurrent model (Source: @Manning2022).

<!--
![Sequential processing of recurrent model. Source:
[@Manning2022].](transformer_rnnlim_stanford.png){#fig:tf_rnnlim_stanford
width="70%"}
-->
...
```{r fig:tf_rnnlim2_stanford, echo=FALSE, out.width="70%", fig.cap="(ref:tf_rnnlim2_stanford)", fig.align="center"}
knitr::include_graphics("./figures/01-01-nlp/transformer_rnnlim2_stanford.png")
```
(ref:tf_rnnlim2_stanford) Sequential processing of recurrent model with number of steps indicated (Source: @Manning2022).

<!--
![Sequential processing of recurrent model with number of steps
indicated. Source:
[@Manning2022].](transformer_rnnlim2_stanford.png){#fig:tf_rnnlim2_stanford
width="70%"}
-->
...
```{r fig:tf_self-a, echo=FALSE, out.width="70%", fig.cap="(ref:tf_self-a)", fig.align="center"}
knitr::include_graphics("./figures/01-01-nlp/transformer_self-attention_stanford.png")
```
(ref:tf_self-a) Connections of classic attention mechanism (Source: @Manning2022).

<!--
![Connections of classic attention mechanism. Source:
[@Manning2022]](transformer_self-attention_stanford.png){#fig:tf_self-a
width="70%"}
-->
...
```{r fig:tf_hashtable, echo=FALSE, out.width="70%", fig.cap="(ref:tf_hashtable)", fig.align="center"}
knitr::include_graphics("./figures/01-01-nlp/transformer_hash-table_stanford.png")
```
(ref:tf_hashtable) Comparison of classic attention mechanism with self-attention with
hash tables (Source: @Manning2022).

<!--
![Comparison of classic attention mechanism with self-attention with
hash tables. Source:
[@Manning2022]](transformer_hash-table_stanford.png){#fig:tf_hashtable
width="70%"}
-->
...
the original transformer-architecture proposed by [@vaswani2017attention]. The
...
```{r fig:tf_sdpa, echo=FALSE, out.width="18%", fig.cap="(ref:tf_sdpa)", fig.align="center"}
knitr::include_graphics("./figures/01-01-nlp/transformers_scaled-dot-attention2_vaswani.png")
```
(ref:tf_sdpa) Scaled dot-product attention (Source: @vaswani2017attention).

<!--
![Scaled dot-product attention. Source:
[@vaswani2017attention].](transformers_scaled-dot-attention2_vaswani.png){#fig:tf_sdpa
width="18%"}
-->
...
```{r fig:tf_mha, echo=FALSE, out.width="34%", fig.cap="(ref:tf_mha)", fig.align="center"}
knitr::include_graphics("./figures/01-01-nlp/transformers_multi-head-attention2_vaswani.png")
```
(ref:tf_mha) Multi-head attention (Source: @vaswani2017attention).

<!--
![Multi-head attention. Source:
[@vaswani2017attention]](transformers_multi-head-attention2_vaswani.png){#fig:tf_mha
width="34%"}
-->
...
```{r fig:tf_arch, echo=FALSE, out.width="55%", fig.cap="(ref:tf_arch)", fig.align="center"}
knitr::include_graphics("./figures/01-01-nlp/transformer_arch_vaswani.png")
```
(ref:tf_arch) Transformer architecture (Source: @vaswani2017attention).

<!--
![Transformer architecture. Source:
[@vaswani2017attention].](transformer_arch_vaswani.png){#fig:tf_arch width="55%"}
-->
...
```{r fig:tf_pretrain, echo=FALSE, out.width="80%", fig.cap="(ref:tf_pretrain)", fig.align="center"}
knitr::include_graphics("./figures/01-01-nlp/transformer_pretrain_stanford.png")
```
(ref:tf_pretrain) Partly pre-trained model (Source: @Manning2022).

<!--
![image](transformer_pretrain_stanford.png){#fig:tf_pretrain2
width=".8\\linewidth"} [\[fig:tf_pretrain\]]{#fig:tf_pretrain
label="fig:tf_pretrain"}
-->

```{r fig:tf_pretrain2, echo=FALSE, out.width="80%", fig.cap="(ref:tf_pretrain2)", fig.align="center"}
knitr::include_graphics("./figures/01-01-nlp/transformer_pretrain2_stanford.png")
```
(ref:tf_pretrain2) Jointly pre-trained model (Source: @Manning2022).

<!--
![image](transformer_pretrain2_stanford.png){#fig:tf_pretrain2
width=".8\\linewidth"} [\[fig:tf_pretrain2\]]{#fig:tf_pretrain2
label="fig:tf_pretrain2"}
-->

<!--
```{r, echo=FALSE,out.width="49%",out.height="49%",fig.show='hold',
fig.align='center', fig.cap="Partly pre-trained and jointly pre-trained model."}
knitr::include_graphics(c("tf_pretrain.png","tf_pretrain2.png"))
-->
...
```{r fig:t5, echo=FALSE, out.width="80%", fig.cap="(ref:t5)", fig.align="center"}
knitr::include_graphics("./figures/01-01-nlp/t5_stanford.png")
```
(ref:t5) Applications of T5 model (Source: @Raffel2019).

<!--
![Applications of T5 model. Source:
[@Raffel2019].](t5_stanford.png){#fig:t5 width="80%"}
-->
...
```{r fig:gpt3_scaling, echo=FALSE, out.width="70%", fig.cap="(ref:gpt3_scaling)", fig.align="center"}
knitr::include_graphics("./figures/01-01-nlp/gpt3_comparison.png")
```
(ref:gpt3_scaling) Comparison of number of parameters between Transformer-architectures (Source: @Saifee2020).

<!--
![Comparison of number of parameters between Transformer-architectures.
Source: [@Saifee2020]](gpt3_comparison.png){#fig:gpt3_scaling
width="70%"}
-->
...
increasing resource consumption. [@strubel2019energy] estimated that training
...
```{r fig:ct_attention-heads, echo=FALSE, out.width="90%", fig.cap="(ref:ct_attention-heads)", fig.align="center"}
knitr::include_graphics("./figures/01-01-nlp/ct_attention-heads.png")
```
(ref:ct_attention-heads) Common patterns of attention heads (Source: @Clark2019).

<!--
![Common patterns of attention heads. Source:
[@Clark2019]](ct_attention-heads.png){#fig:ct_attention-heads
width="90%"}
-->
...
```{r fig:gpt3_few-shot-learning, echo=FALSE, out.width="50%", fig.cap="(ref:gpt3_few-shot-learning)", fig.align="center"}
knitr::include_graphics("./figures/01-01-nlp/gpt3_few-shot-learning.png")
```
(ref:gpt3_few-shot-learning) Few-shot learning (Source: @brown2020language).

<!--
![Few-shot learning. Source:
[@brown2020language]](gpt3_few-shot-learning.png){#fig:gpt3_few-shot-learning
width="50%"}
-->
...
language models is overestimated (see [@perez2021true]).\
