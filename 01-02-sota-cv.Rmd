...
The question of possibility of scaling by all three dimensions was answered by @EfficientNet in the work presenting EfficientNet. This network was built by scaling up ConvNets by all three dimensions and will also be described here.
