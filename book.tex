...
\hypertarget{c03-03-MoE}{%
\subsubsection{Mixture-of-Experts}\label{c03-03-MoE}}
...
\hypertarget{c03-03-EA}{%
\subsubsection{Evolutionary Algorithms}\label{c03-03-EA}}
...
and a \protect\hyperlink{c03-03-MoE}{mixture-of-expert} layer. The I/O mixer and the decoder combine their dual input using cross-attention. A positional encoding conceptually similar to the one in transformers \citep{vaswani2017attention}
...
An initial model is evolved by using an \protect\hyperlink{c03-03-EA}{evoluationary algorithm} to fit specific tasks, while keeping the previously learned knowledge.
