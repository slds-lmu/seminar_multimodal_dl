...
Figure \@ref(fig:performance-clip) compares the performance of CLIP and a ResNet101 trained on ImageNet until it reached the same accuracy as zero-shot CLIP.
...
With datasets coming from more and more different data-generating distributions to ImageNet the performance of ResNet101 deteriorates while CLIP remains fairly accurate. \
...
* Training data not released to the public, can't be validated.
