...
The following figure gives a summary of the SuperGLUE tasks.

![taken from https://mccormickml.com](figures/01-chapter1/SuperGLUE.png)


Subchapter abschließen mit NLU benachmarks broken paper. Most of the time binary classification and no real understanding needed.
      ...
      \item different tasks for benchmarks
        \begin{itemize}
          ...
          \begin{itemize}
            ...
            \item NLVR
          \end{itemize}
          \item Hint that it's most of the time reduction to classification tasks (like is this next sentences) (not sure if still true, maybe mainly NLP)
