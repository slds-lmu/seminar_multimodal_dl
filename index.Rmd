...
```{r cover, cache=FALSE, out.width="800", fig.align="center", fig.cap="LMU seal (left) style-transferred to Van Gogh's Sunflower painting (center) and blended with the prompt <Van Gogh, sunflowers> via CLIP+VGAN.", echo=FALSE, eval = is.html}
